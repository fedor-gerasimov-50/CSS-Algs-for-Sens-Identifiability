...
%%% sub-function SVIRrhs: creates right hand side of ODE system
    function yprime = COVIDrhs(t, x, params)
        ...
        yprime(4) = sigma * eta * E - gamma * A; %%% A
        yprime(5) = (1-sigma)*eta * E - gamma * I; %%% I
        yprime(6) = delta * gamma * I - omega * H; %%% H
        yprime(7) = gamma * A + (1-delta) * gamma* I  + omega * H; %%% R 
